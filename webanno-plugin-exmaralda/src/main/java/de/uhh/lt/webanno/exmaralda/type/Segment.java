  ...
  */  
  ...
  public String getID() {
    if (Segment_Type.featOkTst && ((Segment_Type)jcasType).casFeat_ID == null)
      jcasType.jcas.throwFeatMissing("ID", "de.uhh.lt.webanno.exmaralda.type.Segment");
  ...
  public String getSegmentType() {
    if (Segment_Type.featOkTst && ((Segment_Type)jcasType).casFeat_SegmentType == null)
      jcasType.jcas.throwFeatMissing("SegmentType", "de.uhh.lt.webanno.exmaralda.type.Segment");
  ...
  public String getSegmentSubtype() {
    if (Segment_Type.featOkTst && ((Segment_Type)jcasType).casFeat_SegmentSubtype == null)
      jcasType.jcas.throwFeatMissing("SegmentSubtype", "de.uhh.lt.webanno.exmaralda.type.Segment");
  ...
  public String getUtteranceID() {
    if (Segment_Type.featOkTst && ((Segment_Type)jcasType).casFeat_UtteranceID == null)
      jcasType.jcas.throwFeatMissing("UtteranceID", "de.uhh.lt.webanno.exmaralda.type.Segment");
  ...
  public String getSpeakerID() {
    if (Segment_Type.featOkTst && ((Segment_Type)jcasType).casFeat_SpeakerID == null)
      jcasType.jcas.throwFeatMissing("SpeakerID", "de.uhh.lt.webanno.exmaralda.type.Segment");
  ...
  public int getSentenceNumber() {
    if (Segment_Type.featOkTst && ((Segment_Type)jcasType).casFeat_SentenceNumber == null)
      jcasType.jcas.throwFeatMissing("SentenceNumber", "de.uhh.lt.webanno.exmaralda.type.Segment");
