 ...
 * @generated */
public class PlayableAnchor_Type extends Annotation_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = PlayableAnchor.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.uhh.lt.webanno.exmaralda.type.PlayableAnchor");
  ...
  public String getInfo(int addr) {
      ...
      jcas.throwFeatMissing("Info", "de.uhh.lt.webanno.exmaralda.type.PlayableAnchor");
  ...
  public String getAnchorID(int addr) {
      ...
      jcas.throwFeatMissing("AnchorID", "de.uhh.lt.webanno.exmaralda.type.PlayableAnchor");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public PlayableAnchor_Type(JCas jcas, Type casType) {
    super(jcas, casType);
