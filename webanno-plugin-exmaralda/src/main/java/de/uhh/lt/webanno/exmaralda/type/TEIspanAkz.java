 ...
 * @generated */
public class TEIspanAkz extends Annotation {
  /** @generated
   * @ordered 
   */
  ...
  */  
  ...
  public String getSpanType() {
    if (TEIspanAkz_Type.featOkTst && ((TEIspanAkz_Type)jcasType).casFeat_SpanType == null)
      jcasType.jcas.throwFeatMissing("SpanType", "de.uhh.lt.webanno.exmaralda.type.TEIspanAkz");
  ...
  public String getStartID() {
    if (TEIspanAkz_Type.featOkTst && ((TEIspanAkz_Type)jcasType).casFeat_StartID == null)
      jcasType.jcas.throwFeatMissing("StartID", "de.uhh.lt.webanno.exmaralda.type.TEIspanAkz");
  ...
  public String getEndID() {
    if (TEIspanAkz_Type.featOkTst && ((TEIspanAkz_Type)jcasType).casFeat_EndID == null)
      jcasType.jcas.throwFeatMissing("EndID", "de.uhh.lt.webanno.exmaralda.type.TEIspanAkz");
  ...
  public String getContent() {
    if (TEIspanAkz_Type.featOkTst && ((TEIspanAkz_Type)jcasType).casFeat_Content == null)
      jcasType.jcas.throwFeatMissing("Content", "de.uhh.lt.webanno.exmaralda.type.TEIspanAkz");
  ...
  public String getSpeakerID() {
    if (TEIspanAkz_Type.featOkTst && ((TEIspanAkz_Type)jcasType).casFeat_SpeakerID == null)
      jcasType.jcas.throwFeatMissing("SpeakerID", "de.uhh.lt.webanno.exmaralda.type.TEIspanAkz");
