...
//@MountPath(value = "/partitur", alt = "/partitur/${" + ExmaraldaPartitur_old.PAGE_PARAM_PROJECT_ID + "}/${"+ ExmaraldaPartitur_old.PAGE_PARAM_DOCUMENT_ID + "}")
public class ExmaraldaPartitur_old extends WebPage {

	public static final String PAGE_PARAM_PROJECT_ID = "pId";
	public static final String PAGE_PARAM_DOCUMENT_ID = "dId";

	private static final Logger LOG = LoggerFactory.getLogger(ExmaraldaPartitur_old.class);
