...
WebAnno User Guide
==================
:Author: The WebAnno-MM Team

== Introduction

This guide summarizes the functionality of WebAnno-MM from the user's perspective.
...
All materials, including this guide, are available via the link:...[...WebAnno-MM homepage].
...
include::{include-dir}partitur.adoc[]