...
public class TEIspanEn_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.uhh.lt.webanno.mm.type.TEIspanEn");
  ...
  public String getSpanType(int addr) {
      ...
      jcas.throwFeatMissing("SpanType", "de.uhh.lt.webanno.mm.type.TEIspanEn");
  ...
  public String getStartID(int addr) {
      ...
      jcas.throwFeatMissing("StartID", "de.uhh.lt.webanno.mm.type.TEIspanEn");
  ...
  public String getEndID(int addr) {
      ...
      jcas.throwFeatMissing("EndID", "de.uhh.lt.webanno.mm.type.TEIspanEn");
  ...
  public String getContent(int addr) {
      ...
      jcas.throwFeatMissing("Content", "de.uhh.lt.webanno.mm.type.TEIspanEn");
  ...
  public String getSpeakerID(int addr) {
      ...
      jcas.throwFeatMissing("SpeakerID", "de.uhh.lt.webanno.mm.type.TEIspanEn");
