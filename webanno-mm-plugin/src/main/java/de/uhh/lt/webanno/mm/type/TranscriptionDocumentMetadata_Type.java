...
public class TranscriptionDocumentMetadata_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.uhh.lt.webanno.mm.type.TranscriptionDocumentMetadata");
  ...
  public int getTeiMetadataByteArray(int addr) {
      ...
      jcas.throwFeatMissing("TeiMetadataByteArray", "de.uhh.lt.webanno.mm.type.TranscriptionDocumentMetadata");
