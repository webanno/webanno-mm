 ...
 * @generated */
public class TEIspanAkz_Type extends Annotation_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = TEIspanAkz.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.uhh.lt.webanno.exmaralda.type.TEIspanAkz");
  ...
  public String getSpanType(int addr) {
      ...
      jcas.throwFeatMissing("SpanType", "de.uhh.lt.webanno.exmaralda.type.TEIspanAkz");
  ...
  public String getStartID(int addr) {
      ...
      jcas.throwFeatMissing("StartID", "de.uhh.lt.webanno.exmaralda.type.TEIspanAkz");
  ...
  public String getEndID(int addr) {
      ...
      jcas.throwFeatMissing("EndID", "de.uhh.lt.webanno.exmaralda.type.TEIspanAkz");
  ...
  public String getContent(int addr) {
      ...
      jcas.throwFeatMissing("Content", "de.uhh.lt.webanno.exmaralda.type.TEIspanAkz");
  ...
  public String getSpeakerID(int addr) {
      ...
      jcas.throwFeatMissing("SpeakerID", "de.uhh.lt.webanno.exmaralda.type.TEIspanAkz");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public TEIspanAkz_Type(JCas jcas, Type casType) {
    super(jcas, casType);
