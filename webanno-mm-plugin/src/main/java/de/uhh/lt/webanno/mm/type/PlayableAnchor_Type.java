...
public class PlayableAnchor_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.uhh.lt.webanno.mm.type.PlayableAnchor");
  ...
  public String getInfo(int addr) {
      ...
      jcas.throwFeatMissing("Info", "de.uhh.lt.webanno.mm.type.PlayableAnchor");
  ...
  public String getAnchorID(int addr) {
      ...
      jcas.throwFeatMissing("AnchorID", "de.uhh.lt.webanno.mm.type.PlayableAnchor");
