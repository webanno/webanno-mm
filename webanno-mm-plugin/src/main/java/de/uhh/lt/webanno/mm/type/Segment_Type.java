...
public class Segment_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.uhh.lt.webanno.mm.type.Segment");
  ...
  public String getID(int addr) {
      ...
      jcas.throwFeatMissing("ID", "de.uhh.lt.webanno.mm.type.Segment");
  ...
  public String getSegmentType(int addr) {
      ...
      jcas.throwFeatMissing("SegmentType", "de.uhh.lt.webanno.mm.type.Segment");
  ...
  public String getSegmentSubtype(int addr) {
      ...
      jcas.throwFeatMissing("SegmentSubtype", "de.uhh.lt.webanno.mm.type.Segment");
  ...
  public String getUtteranceID(int addr) {
      ...
      jcas.throwFeatMissing("UtteranceID", "de.uhh.lt.webanno.mm.type.Segment");
  ...
  public String getSpeakerID(int addr) {
      ...
      jcas.throwFeatMissing("SpeakerID", "de.uhh.lt.webanno.mm.type.Segment");
  ...
  public int getSentenceNumber(int addr) {
      ...
      jcas.throwFeatMissing("SentenceNumber", "de.uhh.lt.webanno.mm.type.Segment");
