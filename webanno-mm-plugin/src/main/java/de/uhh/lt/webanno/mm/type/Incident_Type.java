...
public class Incident_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.uhh.lt.webanno.mm.type.Incident");
  ...
  public String getDesc(int addr) {
      ...
      jcas.throwFeatMissing("Desc", "de.uhh.lt.webanno.mm.type.Incident");
  ...
  public String getStartID(int addr) {
      ...
      jcas.throwFeatMissing("StartID", "de.uhh.lt.webanno.mm.type.Incident");
  ...
  public String getEndID(int addr) {
      ...
      jcas.throwFeatMissing("EndID", "de.uhh.lt.webanno.mm.type.Incident");
  ...
  public String getSpeakerID(int addr) {
      ...
      jcas.throwFeatMissing("SpeakerID", "de.uhh.lt.webanno.mm.type.Incident");
  ...
  public String getIncidentType(int addr) {
      ...
      jcas.throwFeatMissing("IncidentType", "de.uhh.lt.webanno.mm.type.Incident");
  ...
  public boolean getIsTextual(int addr) {
      ...
      jcas.throwFeatMissing("isTextual", "de.uhh.lt.webanno.mm.type.Incident");
