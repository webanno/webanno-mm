 ...
 * @generated */
public class TEIspanGeneric_Type extends Annotation_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = TEIspanGeneric.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.uhh.lt.webanno.exmaralda.type.TEIspanGeneric");
  ...
  public String getSpanType(int addr) {
      ...
      jcas.throwFeatMissing("SpanType", "de.uhh.lt.webanno.exmaralda.type.TEIspanGeneric");
  ...
  public String getStartID(int addr) {
      ...
      jcas.throwFeatMissing("StartID", "de.uhh.lt.webanno.exmaralda.type.TEIspanGeneric");
  ...
  public String getEndID(int addr) {
      ...
      jcas.throwFeatMissing("EndID", "de.uhh.lt.webanno.exmaralda.type.TEIspanGeneric");
  ...
  public String getContent(int addr) {
      ...
      jcas.throwFeatMissing("Content", "de.uhh.lt.webanno.exmaralda.type.TEIspanGeneric");
  ...
  public String getSpeakerID(int addr) {
      ...
      jcas.throwFeatMissing("SpeakerID", "de.uhh.lt.webanno.exmaralda.type.TEIspanGeneric");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public TEIspanGeneric_Type(JCas jcas, Type casType) {
    super(jcas, casType);
