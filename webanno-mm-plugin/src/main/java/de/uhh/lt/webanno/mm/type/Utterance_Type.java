...
public class Utterance_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.uhh.lt.webanno.mm.type.Utterance");
  ...
  public String getID(int addr) {
      ...
      jcas.throwFeatMissing("ID", "de.uhh.lt.webanno.mm.type.Utterance");
  ...
  public String getSpeakerID(int addr) {
      ...
      jcas.throwFeatMissing("SpeakerID", "de.uhh.lt.webanno.mm.type.Utterance");
  ...
  public String getStartID(int addr) {
      ...
      jcas.throwFeatMissing("StartID", "de.uhh.lt.webanno.mm.type.Utterance");
  ...
  public String getEndID(int addr) {
      ...
      jcas.throwFeatMissing("EndID", "de.uhh.lt.webanno.mm.type.Utterance");
  ...
  public String getSpeakerABBR(int addr) {
      ...
      jcas.throwFeatMissing("SpeakerABBR", "de.uhh.lt.webanno.mm.type.Utterance");
