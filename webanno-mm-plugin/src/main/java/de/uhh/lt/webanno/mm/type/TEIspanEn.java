  ...
  */  
  ...
  public String getSpanType() {
    if (TEIspanEn_Type.featOkTst && ((TEIspanEn_Type)jcasType).casFeat_SpanType == null)
      jcasType.jcas.throwFeatMissing("SpanType", "de.uhh.lt.webanno.mm.type.TEIspanEn");
  ...
  public String getStartID() {
    if (TEIspanEn_Type.featOkTst && ((TEIspanEn_Type)jcasType).casFeat_StartID == null)
      jcasType.jcas.throwFeatMissing("StartID", "de.uhh.lt.webanno.mm.type.TEIspanEn");
  ...
  public String getEndID() {
    if (TEIspanEn_Type.featOkTst && ((TEIspanEn_Type)jcasType).casFeat_EndID == null)
      jcasType.jcas.throwFeatMissing("EndID", "de.uhh.lt.webanno.mm.type.TEIspanEn");
  ...
  public String getContent() {
    if (TEIspanEn_Type.featOkTst && ((TEIspanEn_Type)jcasType).casFeat_Content == null)
      jcasType.jcas.throwFeatMissing("Content", "de.uhh.lt.webanno.mm.type.TEIspanEn");
  ...
  public String getSpeakerID() {
    if (TEIspanEn_Type.featOkTst && ((TEIspanEn_Type)jcasType).casFeat_SpeakerID == null)
      jcasType.jcas.throwFeatMissing("SpeakerID", "de.uhh.lt.webanno.mm.type.TEIspanEn");
