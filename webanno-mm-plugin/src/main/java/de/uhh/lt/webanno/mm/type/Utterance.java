  ...
  */  
  ...
  public String getID() {
    if (Utterance_Type.featOkTst && ((Utterance_Type)jcasType).casFeat_ID == null)
      jcasType.jcas.throwFeatMissing("ID", "de.uhh.lt.webanno.mm.type.Utterance");
  ...
  public String getSpeakerID() {
    if (Utterance_Type.featOkTst && ((Utterance_Type)jcasType).casFeat_SpeakerID == null)
      jcasType.jcas.throwFeatMissing("SpeakerID", "de.uhh.lt.webanno.mm.type.Utterance");
  ...
  public String getStartID() {
    if (Utterance_Type.featOkTst && ((Utterance_Type)jcasType).casFeat_StartID == null)
      jcasType.jcas.throwFeatMissing("StartID", "de.uhh.lt.webanno.mm.type.Utterance");
  ...
  public String getEndID() {
    if (Utterance_Type.featOkTst && ((Utterance_Type)jcasType).casFeat_EndID == null)
      jcasType.jcas.throwFeatMissing("EndID", "de.uhh.lt.webanno.mm.type.Utterance");
  ...
  public String getSpeakerABBR() {
    if (Utterance_Type.featOkTst && ((Utterance_Type)jcasType).casFeat_SpeakerABBR == null)
      jcasType.jcas.throwFeatMissing("SpeakerABBR", "de.uhh.lt.webanno.mm.type.Utterance");
